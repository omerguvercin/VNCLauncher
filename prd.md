# VNC Launcher PRD (Product Requirements Document)

## Amaç
Kullanıcıların VNC bağlantılarını kolayca yönetmesini ve hızlıca bağlanmasını sağlamak.

## Temel Özellikler
- Adres defteri ile bağlantı kaydı ve düzenleme
- Favori ekleme/çıkarma
- IP adresi ve bağlantı adı validasyonu
- TightVNC yolu ve port ayarı
- Bağımlılık kontrolü (TightVNC ve .NET)
- Modern hata ve başarı bildirimleri
- Yardım sekmesinde gereksinimler ve linkler

## Kullanıcı Senaryoları
- Kullanıcı yeni bağlantı ekler, validasyon yapılır
- Bağlantıya çift tıklandığında TightVNC başlatılır
- TightVNC yolu hatalıysa modern hata ekranı çıkar
- Ayarlar kaydedildiğinde modern başarı bildirimi çıkar
...
## 9. Gelecek Geliştirmeler ve Bilinen Sorunlar
